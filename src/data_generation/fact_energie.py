...
LINIEN = {
    1:  {"standort_id": 1, "code": "BER-L1", "typ": "Spritzguss", "nennleistung_kw": 450},
    2:  {"standort_id": 1, "code": "BER-L2", "typ": "Spritzguss", "nennleistung_kw": 520},
    3:  {"standort_id": 1, "code": "BER-L3", "typ": "Montage", "nennleistung_kw": 180},
    4:  {"standort_id": 2, "code": "MUC-L1", "typ": "Spritzguss", "nennleistung_kw": 480},
    5:  {"standort_id": 2, "code": "MUC-L2", "typ": "Spritzguss", "nennleistung_kw": 550},
    6:  {"standort_id": 2, "code": "MUC-L3", "typ": "Montage", "nennleistung_kw": 200},
    7:  {"standort_id": 3, "code": "HAM-L1", "typ": "Spritzguss", "nennleistung_kw": 460},
    8:  {"standort_id": 3, "code": "HAM-L2", "typ": "Spritzguss", "nennleistung_kw": 490},
    9:  {"standort_id": 3, "code": "HAM-L3", "typ": "Montage", "nennleistung_kw": 170},
    10: {"standort_id": 4, "code": "FRA-L1", "typ": "Spritzguss", "nennleistung_kw": 440},
    11: {"standort_id": 4, "code": "FRA-L2", "typ": "Spritzguss", "nennleistung_kw": 470},
    12: {"standort_id": 4, "code": "FRA-L3", "typ": "Montage", "nennleistung_kw": 190},
    13: {"standort_id": 5, "code": "LEI-L1", "typ": "Spritzguss", "nennleistung_kw": 450},
    14: {"standort_id": 5, "code": "LEI-L2", "typ": "Spritzguss", "nennleistung_kw": 480},
    15: {"standort_id": 5, "code": "LEI-L3", "typ": "Montage", "nennleistung_kw": 185},
}

# Verträge: Welcher Standort hat wann welchen Vertrag?
VERTRAEGE = {
    1: {"standort_id": 1, "lieferant": "VATT", "von": "2023-01-01", "bis": "2024-06-30"},
    2: {"standort_id": 1, "lieferant": "EOND", "von": "2024-07-01", "bis": "2024-12-31"},
    3: {"standort_id": 2, "lieferant": "VATT", "von": "2023-01-01", "bis": "2024-12-31"},
    4: {"standort_id": 3, "lieferant": "NATU", "von": "2023-01-01", "bis": "2024-12-31"},
    5: {"standort_id": 4, "lieferant": "EOND", "von": "2023-01-01", "bis": "2024-12-31"},
    6: {"standort_id": 5, "lieferant": "SPOT", "von": "2023-01-01", "bis": "2024-12-31"},
}
